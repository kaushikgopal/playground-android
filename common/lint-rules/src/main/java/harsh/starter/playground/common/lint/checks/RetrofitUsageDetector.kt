...
import harsh.starter.playground.common.lint.utils.removeNode
import harsh.starter.playground.common.lint.utils.safeReturnType
import harsh.starter.playground.common.lint.utils.sourceImplementation
    ...
    override fun createUastHandler(context: JavaContext): UElementHandler {
        return object : UElementHandler() {
            override fun visitMethod(node: UMethod) {
                ...
                val hasPath =
                    (httpAnnotation.findDeclaredAttributeValue("value")?.evaluate() as? String)
                        ?.isNotBlank() ?: false
