 ...
 *
 * This delegate provides a lazy-initialized, thread-safe internal state holder that can be used for
 * managing ViewModel-specific state separate from UI state.
 *
 * Usage:
 * ```
 ...
 */
class InternalState<T>(private val initializer: () -> T) :
